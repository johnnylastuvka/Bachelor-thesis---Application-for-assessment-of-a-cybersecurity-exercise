...
%% Komplexněji popsat nasazení na Cyberexu + chyby a jejich opravi a iterace nad applikací
%% pozor na překryv se závěrem, případně závěr přepsat
...
%% - lepší nástroje pro správu - avšak nasadil jsem tam sql explorer tak promyslet...
...
%% toto ještě promyslet:
%%Během vývoje jsem se setkal s technologiemi, které pro mě byly zcela nové a práce tak pro mě měla velký přínos. 
