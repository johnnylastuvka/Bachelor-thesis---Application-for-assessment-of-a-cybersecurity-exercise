...
%% Zatím spíše pracovní závěr
%% - popisuje jak výsledek práce, tak nasazení na cyberex, 
%% tak doporučení pro další vývoj
%% 
%% formulujte doporučení pro další rozvoj.
%% --------------------
%% - správa týmů přes portál 
%% - správa uživatelů přes portál
%% - mapa nedostupných služeb automatického skóringu
%% - stránkování na backendu (aut. skóring i manual) ??? Asi zbytečné
%% - 
...
Vytvořená aplikace byla použita hned při dvou cvičeních Cyber Czech 2018 a reálné nasazení skórovací aplikace neobjevilo žádné vážné nedostatky. Během druhého cvičení se objevily problémy s odezvou API, které však byly způsobeny dlouhodobým přetížením serveru, kde byla aplikace spuštěna. Dále se ukázalo, že v aplikaci chybí nástroj, pro efektivní hromadné mazání automatických hodnocení. Při cvičení se objevila chyba v jednom ze systémů se kterým pracovali členové modrého týmu. Vlivem této chyby došlo k vložení několika stovek automatických hodnocení, které bylo potřeba smazat. Veškeré záznamy musely být manuálně vyhledány a smazány. 

Díky reálnému využití je zcela jisté, že v budoucnu bude vývoj aplikace dále pokračovat. Již během druhého cvičení se zjistilo, že aplikace potřebuje lepší nástroje pro správu dat, pro případ nutnosti administrátorského zásahu. Další zajímavou funkcí, kterou by aplikace mohla disponovat, je výpis všech služeb, které jsou kontrolovány automatickým skóringem, a to včetně stavu těchto služeb. Výpisu by mohlo být využito pro znázornění, které služby jsou aktuálně dostupné nebo nedostupné a tento přehled by mohl být využit i pro porovnávání aktuálního stavu mezi všemi tými. Funkce, která by mohla přinést zjednodušení v práci s aplikací, je propojení správy uživatelů s již existujícím systémem v KYPO. Uživatelské účty jsou zvlášť vytvářeny ve skórovací aplikaci a zvlášť v portálu KYPO, který slouží pro přístup ke všem ostatním systémům používaným při cvičení. Pokud by do budoucna bylo možné tyto přihlašovací procesy spojit, přineslo by to zjednodušení celé správy uživatelů. Obdobný námět na vylepšení platí i pro správu týmů, které jsou opět zadávány do portálu KYPO a samostatně do skórovací aplikace. Ve skórovací aplikaci je pak u týmu uložen identifikátor z portálu KYPO. 
